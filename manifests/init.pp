...
class nginx (
  ...
  ### END Hiera Lookups ###
  $nx_forward_ip                  = $nginx::params::nx_forward_ip,
  $nx_set_real_ip                 = $nginx::params::nx_set_real_ip,
  $nx_real_ip_header              = $nginx::params::nx_real_ip_header,
  $nginx_source_version           = $nginx::params::nginx_source_version
